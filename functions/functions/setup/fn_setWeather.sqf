...
//OVERCAST =====================================================================
//random
if (hp_missionParam_WEATHERSETTING == -1) then {
...
//fixed
    ...
    _overcast = hp_missionParam_WEATHERSETTING;
};

["LOG", "SERVER_SETUP", format ["fn_setWeather - Set overcast to %1.", _overcast]] call hp_fnc_diagReport;
...
if (hp_missionParam_TIMEOFDAY <= 8) then {
    _mid = _mid + 0.12;
};

_fog = random [0,_mid,0.4];

["LOG", "SERVER_SETUP", format ["fn_setWeather - Set fog to %1.", _fog]] call hp_fnc_diagReport;
0 setFog _fog;
